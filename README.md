...
![alt text](image-1.png)https://youtu.be/7GBtzrth0v4

## Story Description

In my project I included images of friends and family that are closest to me in my life. They are a huge part of my life so I thought that they are important enough to be in this project. Also a huge part of my life is baseball so I put images of me playing baseball into my project. I play baseball here at school on the Chatsworth Baseball team. In this project I used 2-D arrays for my friends names, and also for speeds of my pitches in baseball. 

## Image Filter Analysis

A filter I used is the colorize filter, which changes each pixel based on its brightness. It calculates the average of the red, green, and blue values and then replaces the pixel with pure red, green, or blue depending on that brightness level. This completely replaces the original colors and creates a bold, poster-like effect. Another filter I used is the sharpen filter, which compares each pixel to a neighboring pixel, adds the color difference back to the original values, and increases contrast to make edges appear sharper.
